...
exports.CASE_CATALOG = exports.GIFT_TYPE_CATALOG = void 0;
exports.getCaseCatalogEntry = getCaseCatalogEntry;
exports.GIFT_TYPE_CATALOG = [
    {
        id: 'starter-rose',
        name: 'Rose Bloom',
        image: '/images/07.png',
...
function getCaseCatalogEntry(slug) {
    return exports.CASE_CATALOG.find(function (caseItem) { return caseItem.slug === slug; });
}
